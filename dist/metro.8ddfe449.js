...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/lib/metro.js":[function(require,module,exports) {
var define;
...
(function (factory) {
  ...
  (function (global, undefined) {
    ...
    function _isHidden(elem) {
      ...
      return !_isVisible(elem) || +s['opacity'] === 0 || elem.hidden || s['visibility'] === "hidden";
    }
    ...
    (function (global, undefined) {
      ...
      Promise.prototype = {
        ...
        done: function done(onFulfillment) {
          return this.then(onFulfillment, null);
        },
        always: function always(onAlways) {
    ...
    })(window); // Source: src/core.js


    var m4qVersion = "v1.0.4. Built at 24/11/2019 13:28:24";
    var regexpSingleTag = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;

    var _matches = Element.prototype.matches || Element.prototype["matchesSelector"] || Element.prototype["webkitMatchesSelector"] || Element.prototype["mozMatchesSelector"] || Element.prototype["msMatchesSelector"] || Element.prototype["oMatchesSelector"];
    ...
    if (typeof window["hideM4QVersion"] === "undefined") console.info("m4q " + $.version); // Source: src/interval.js
    ...
    $.extend({
      ...
      setTimeout: function setTimeout(fn, interval) {
        var that = this,
    ...
    $.fn.extend({
      ...
      eq: function eq(i) {
        return !_not(i) && this.length > 0 ? $.extend($(this.get(i)), {
          _prevObj: this
        }) : this;
      },
      is: function is(s) {
        ...
        if (s === ":selected") {
          ...
          this.each(function () {
            if (_matches.call(this, s)) {
              result = true;
            }
          });
        } else if (_isArrayLike(s)) {
          this.each(function () {
            var el = this;
            $.each(s, function () {
              var sel = this;
        ...
        } else if (_typeof(s) === "object" && s.nodeType === 1) {
          this.each(function () {
            if (this === s) {
              result = true;
            }
      ...
      filter: function filter(fn) {
        ...
        return $.extend($.merge($(), [].filter.call(this, fn)), {
          _prevObj: this
        });
      },
      ...
      children: function children(s) {
        ...
        this.each(function () {
          ...
          for (i = 0; i < el.children.length; i++) {
            if (el.children[i].nodeType === 1) res.push(el.children[i]);
          }
        });
        res = s ? res.filter(function (el) {
          return _matches.call(el, s);
        }) : res;
        return $.extend($.merge($(), res), {
          _prevObj: this
        });
      },
      ...
      _siblingAll: function _siblingAll(dir, s) {
        var res = [];
      ...
      _sibling: function _sibling(dir, s) {
        var res = [];
      ...
      prevAll: function prevAll(s) {
        return this._siblingAll('previousElementSibling', s);
      },
      nextAll: function nextAll(s) {
      ...
      closest: function closest(s) {
        ...
        return $.extend($.merge($(), res.reverse()), {
          _prevObj: this
        });
      },
    ...
    $.fn.extend({
      _prop: function _prop(prop, value) {
      ...
      prop: function prop(_prop2, value) {
      ...
      html: function html(value) {
        ...
        that._prop('innerHTML', v.length === 1 && _not(v[0]) ? "" : v.join("\n"));
    ...
    $.each = function (ctx, cb) {
      ...
      if (_isArrayLike(ctx)) {
        ...
        for (var key in ctx) {
          if (ctx.hasOwnProperty(key)) cb.apply(ctx[key], [key, ctx[key], index++]);
        }
      }
    ...
    Data.prototype = {
      ...
      set: function set(owner, data, value) {
        ...
        if (typeof data === "string") {
          cache[_camelCase(data)] = value;
        } else {
          for (prop in data) {
            if (data.hasOwnProperty(prop)) cache[_camelCase(prop)] = data[prop];
          }
        }
      ...
      get: function get(owner, key) {
        return key === undefined ? this.cache(owner) : owner[this.expando] && owner[this.expando][_camelCase(key)];
      },
      ...
      remove: function remove(owner, key) {
        ...
        if (key === undefined || _isEmptyObject(cache)) {
          if (owner.nodeType) {
      ...
      hasData: function hasData(owner) {
        ...
        return cache !== undefined && !_isEmptyObject(cache);
      }
    };

    var _dataSet = new Data('m4q');

    $.extend({
      hasData: function hasData(elem) {
        return _dataSet.hasData(elem);
      },
      data: function data(elem, key, val) {
        return _dataSet.access(elem, key, val);
      },
      removeData: function removeData(elem, key) {
        return _dataSet.remove(elem, key);
      },
      dataSet: function dataSet(ns) {
        if (_not(ns)) return _dataSet;
    ...
    $.fn.extend({
      data: function data(key, val) {
        ...
        return this.each(function () {
          _dataSet.set(this, key, val);
        });
      },
      removeData: function removeData(key) {
        return this.each(function () {
          _dataSet.remove(this, key);
        });
      },
      origin: function origin(name, value, def) {
        if (this.length === 0) {
          return this;
        }

        if (_not(name) && _not(value)) {
          return $.data(this[0]);
        }

        if (_not(value)) {
          var res = $.data(this[0], "origin-" + name);
          return !_not(res) ? res : def;
        }
    ...
    $.extend({
      ...
      isSelector: function isSelector(selector) {
      ...
      acceptData: function acceptData(owner) {
        return _acceptData(owner);
      },
      not: function not(val) {
        return _not(val);
      },
      parseUnit: function parseUnit(str, out) {
        return _parseUnit(str, out);
      },
      unit: function unit(str, out) {
        return _parseUnit(str, out);
      },
      ...
      isHidden: function isHidden(elem) {
        return _isHidden(elem);
      },
      iif: function iif(v1, v2, v3) {
        return _iif(v1, v2, v3);
      },
      matches: function matches(el, s) {
        return _matches.call(el, s);
      },
      serializeToArray: function serializeToArray(form) {
        var _form = $(form)[0];
    ...
    $.extend({
      ...
      * */
      setEventHandler: function setEventHandler(obj) {
        var i,
            freeIndex = -1,
            eventObj,
            resultIndex;
      ...
      getEventHandler: function getEventHandler(index) {
      ...
      getEventHooks: function getEventHooks() {
        return this.eventHooks;
      },
      addEventHook: function addEventHook(event, handler, type) {
        if (_not(type)) {
          type = "before";
        }

        $.each(str2arr(event), function () {
          this.eventHooks[_camelCase(type + "-" + this)] = handler;
        });
        return this;
      },
      removeEventHook: function removeEventHook(event, type) {
        if (_not(type)) {
          type = "before";
        }

        $.each(str2arr(event), function () {
          delete this.eventHooks[_camelCase(type + "-" + this)];
        });
        return this;
      },
      removeEventHooks: function removeEventHooks(event) {
        var that = this;
        ...
        if (_not(event)) {
          ...
          $.each(str2arr(event), function () {
            delete that.eventHooks[_camelCase(type + "-" + this)];
          });
        }
    ...
    $.fn.extend({
      on: function on(eventsList, sel, handler, options) {
        if (this.length === 0) {
          return;
        }
        ...
        return this.each(function () {
          ...
          $.each(str2arr(eventsList), function () {
            ...
            h = function h(e) {
              ...
              var beforeHook = $.eventHooks[_camelCase("before-" + name)];

              var afterHook = $.eventHooks[_camelCase("after-" + name)];
            ...
            el.addEventListener(name, h, !_isEmptyObject(options) ? options : false);
            index = $.setEventHandler({
              ...
              ns: ns,
              id: $.eventUID,
              options: !_isEmptyObject(options) ? options : false
            });
            $(el).origin('event-' + originEvent, index);
          });
        });
      },
      one: function one(events, sel, handler, options) {
        if (!_isPlainObject(options)) {
          options = {};
        }
      ...
      off: function off(eventsList, sel, options) {
        if (_isPlainObject(sel)) {
          options = sel;
          sel = null;
        }
        ...
        if (_not(eventsList) || eventsList.toLowerCase() === 'all') {
          return this.each(function () {
            var el = this;
    ...
    "blur focus resize scroll click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup contextmenu touchstart touchend touchmove touchcancel".split(" ").forEach(function (name) {
      $.fn[name] = function (sel, fn, opt) {
        return arguments.length > 0 ? this.on(name, sel, fn, opt) : this.trigger(name);
      };
    });
    $.fn.extend({
    ...
    $.ajax = function (p) {
      return new Promise(function (resolve, reject) {
        ...
        var headers = [];
        var async = _not(p.async) ? true : p.async;
        var url = p.url;

        var exec = function exec(fn, params) {
        ...
        var plainObjectToData = function plainObjectToData(obj) {
          var _data = [];
        ...
        if (p.data instanceof HTMLFormElement) {
          ...
          if (_not(url) && _action && _action.trim() !== "") {
            url = _action;
          }

          if (_method && _method.trim() !== "") {
        ...
        if (isGet(method)) {
          url += typeof data === "string" ? "?" + data : _isEmptyObject(data) ? "" : "?" + JSON.stringify(data);
        }
        ...
        $.each(["readystatechange", "error", "timeout", "progress", "loadstart", "loadend", "abort"], function () {
          var ev = _camelCase("on-" + (this === 'readystatechange' ? 'state' : this));
    ...
    $.fn.extend({
      load: function load(url, data, options) {
        var that = this;
    ...
    $.fn.extend({
      style: function style(name, pseudo) {
        var el;
        ...
        if (_not(name) || name === "all") {
          return getComputedStyle(el, pseudo);
        } else {
          var result = {},
              names = name.split(", ").map(function (el) {
            return ("" + el).trim();
          });
      ...
      removeStyleProperty: function removeStyleProperty(name) {
        if (_not(name) || this.length === 0) return this;
    ...
    $.fn.extend({
      ...
      containsClass: function containsClass(cls) {
    ...
    ['add', 'remove', 'toggle'].forEach(function (method) {
      $.fn[method + "Class"] = function (cls) {
        if (_not(cls) || ("" + cls).trim() === "") return this;
        return this.each(function () {
          var el = this;
    ...
    $.parseHTML = function (data, context) {
      ...
      if (context && !(context instanceof $) && _isPlainObject(context)) {
        $.each(result, function () {
          var el = this;

          for (var name in context) {
            if (context.hasOwnProperty(name)) el.setAttribute(name, context[name]);
          }
        });
      }
    ...
    $.fn.extend({
      ...
      _sizeOut: function _sizeOut(prop, val) {
        ...
        if (!_not(val) && typeof val !== "boolean") {
          return this.each(function () {
            var el = this;
      ...
      outerWidth: function outerWidth(val) {
        return this._sizeOut('width', val);
      },
      outerHeight: function outerHeight(val) {
    ...
    $.fn.extend({
      ...
      position: function position(margin) {
        var ml = 0,
            mt = 0,
            el,
            style;
    ...
    $.extend({
      meta: function meta(name) {
        return _not(name) ? $("meta") : $("meta[name='$name']".replace("$name", name));
      },
      metaBy: function metaBy(name) {
        return _not(name) ? $("meta") : $("meta[$name]".replace("$name", name));
      },
        ...
        ['append', 'prepend'].forEach(function (where) {
          ...
          Object.defineProperty(item, where, {
            ...
            value: function prepend() {
              ...
              if (where === 'prepend') this.insertBefore(docFrag, this.firstChild);else this.appendChild(docFrag);
            }
          });
        });
      });
    ...
    var normalizeElements = function normalizeElements(s) {
      var result = undefined;
      if (typeof s === "string") result = $.isSelector(s) ? $(s) : $.parseHTML(s);else if (s instanceof HTMLElement) result = [s];else if (_isArrayLike(s)) result = s;
      return result;
    };
    ...
    $.fn.extend({
      ...
      appendTo: function appendTo(elements) {
        var _elements = normalizeElements(elements);
      ...
      prependTo: function prependTo(elements) {
        var _elements = normalizeElements(elements);
      ...
      insertBefore: function insertBefore(elements) {
        var _elements = normalizeElements(elements);
      ...
      insertAfter: function insertAfter(elements) {
        var _elements = normalizeElements(elements);
      ...
      clone: function clone(deep, withData) {
        var res = [];
    ...
    var Easing = {
      ...
      easeInBack: function easeInBack(t, m) {
        m = m || 1.70158;
        return t * t * ((m + 1) * t - m);
      },
      easeOutBack: function easeOutBack(t, m) {
        m = m || 1.70158;
        var scaledTime = t / 1 - 1;
        return scaledTime * scaledTime * ((m + 1) * scaledTime + m) + 1;
      },
      easeInOutBack: function easeInOutBack(t, m) {
        m = m || 1.70158;
        var scaledTime = t * 2;
      ...
      easeInElastic: function easeInElastic(t, m) {
        m = m || 0.7;
      ...
      easeOutElastic: function easeOutElastic(t, m) {
        m = m || 0.7;
        var p = 1 - m;
        var scaledTime = t * 2;
      ...
      easeInOutElastic: function easeInOutElastic(t, m) {
        m = m || 0.65;
        var p = 1 - m;
    ...
    $.extend({
      animate: function animate(el, draw, dur, timing, cb) {
        var $el = $(el),
        ...
        if (_isPlainObject(draw)) {
          // TODO add prop value as array [from, to]
          for (key in draw) {
            if (draw.hasOwnProperty(key)) {
              if (!Array.isArray(draw[key])) {
                from = _parseUnit($el.style(key));
                to = _parseUnit(draw[key]);
              } else {
                from = _parseUnit(draw[key][0]);
                to = _parseUnit(draw[key][1]);
              }
      ...
      stop: function stop(el, done) {
        $(el).origin("animation-stop", done === true ? 2 : 1);
      }
    });
    $.fn.extend({
      animate: function animate(draw, dur, timing, cb) {
        return this.each(function () {
    ...
    $.extend({
      hidden: function hidden(el, val, cb) {
        el = $(el)[0];
      ...
      visible: function visible(el, mode, cb) {
        if (mode === undefined) {
          mode = true;
        }
    ...
    $.fn.extend({
      ...
      visible: function visible(mode, cb) {
        return this.each(function () {
    ...
    $.extend({
      ...
      fadeIn: function fadeIn(el, dur, easing, cb) {
        var $el = $(el);

        if (!_isVisible($el[0]) || _isVisible($el[0]) && parseInt($el.style('opacity')) === 0) {
          if (_not(dur) && _not(easing) && _not(cb)) {
            cb = null;
            dur = 1000;
      ...
      fadeOut: function fadeOut(el, dur, easing, cb) {
        var $el = $(el);
        if (!_isVisible($el[0])) return;
      ...
      slideDown: function slideDown(el, dur, easing, cb) {
        var $el = $(el);
      ...
      slideUp: function slideUp(el, dur, easing, cb) {
        var $el = $(el);
        var currHeight;
    ...
    $.fn.extend({
      fadeIn: function fadeIn(dur, easing, cb) {
        return this.each(function () {
          $.fadeIn(this, dur, easing, cb);
        });
      },
      fadeOut: function fadeOut(dur, easing, cb) {
        return this.each(function () {
          $.fadeOut(this, dur, easing, cb);
        });
      },
      slideUp: function slideUp(dur, easing, cb) {
        return this.each(function () {
          $.slideUp(this, dur, easing, cb);
        });
      },
      slideDown: function slideDown(dur, easing, cb) {
        return this.each(function () {
    ...
    $.init = function (sel, ctx) {
      ...
      if (_typeof(sel) === "object" && typeof jQuery !== "undefined" && sel instanceof jQuery) {
        return $.import(sel);
      }
    ...
    $.init.prototype = $.fn; // Source: src/populate.js
  ...
  var normalizeComponentName = function normalizeComponentName(name) {
  ...
  var Metro = {
    ...
    showCompileTime: function showCompileTime() {
      return "Built at: " + Metro.compileTime;
    },
    aboutDlg: function aboutDlg() {
    ...
    observe: function observe() {
      ...
      observerCallback = function observerCallback(mutations) {
    ...
    initHotkeys: function initHotkeys(hotkeys, redefine) {
    ...
    initWidgets: function initWidgets(widgets) {
    ...
    plugin: function plugin(name, object) {
    ...
    destroyPlugin: function destroyPlugin(element, name) {
      var p, mc;
      var el = $(element);
    ...
    destroyPluginAll: function destroyPluginAll(element) {
      var el = $(element);
    ...
    noop: function noop() {},
    noop_true: function noop_true() {
      return true;
    },
    noop_false: function noop_false() {
      return false;
    },
    ...
    checkRuntime: function checkRuntime(el, name) {
      var element = $(el);
    ...
    makeRuntime: function makeRuntime(el, name) {
      var element = $(el);
    ...
    getPlugin: function getPlugin(el, name) {
      var _name = normalizeComponentName(name);

      return Utils.$()($(el)[0]).data(_name);
    },
    makePlugin: function makePlugin(el, name, options) {
      var _name = normalizeComponentName(name);
  ...
  if (typeof Array.from !== "function") {
    Array.from = function (val) {
      ...
      if (val.length === undefined && _typeof(val) === "object") {
  ...
  var Colors = {
    ...
    color: function color(name, palette) {
    ...
    palette: function palette(_palette) {
      _palette = _palette || this.PALETTES.ALL;
      return Object.keys(this[_palette]);
    },
    ...
    rgb2websafe: function rgb2websafe(rgb) {
      return {
    ...
    rgba2websafe: function rgba2websafe(rgba) {
      return {
    ...
    toRGBA: function toRGBA(color, alpha) {
    ...
    toHSLA: function toHSLA(color, alpha) {
      var hsla;
    ...
    grayscale: function grayscale(color, output) {
      output = output || "hex";
      var rgb = this.toRGB(color);
    ...
    lighten: function lighten(color, amount) {
      ...
      var calc = function calc(_color, _amount) {
    ...
    hueShift: function hueShift(h, s) {
      h += s;
    ...
    getScheme: function getScheme(color, name, format, options) {
      this.options = $.extend({}, this.options, options);
      var i;
      var scheme = [];
      var hsv;
      ...
      switch (name) {
        ...
        default:
          console.warn("Unknown scheme name " + name);
      }
  ...
  var Export = {
    ...
    tableToCSV: function tableToCSV(table, filename, options) {
      var that = this,
          o = this.options;
      var body,
          head,
    ...
    createDownload: function createDownload(data, contentType, filename) {
      var blob, anchor, url;
  ...
  String.prototype.toDate = function (format, locale) {
    ...
    var monthNameToNumber = function monthNameToNumber(month) {
      ...
      if (locale !== undefined && locale !== "en-US" && Locales !== undefined && Locales[locale] !== undefined && Locales[locale]['calendar'] !== undefined && Locales[locale]['calendar']['months'] !== undefined) {
  ...
  var TemplateEngine = function TemplateEngine(html, options, conf) {
    var ReEx,
        re = '<%(.+?)%>',
  ...
  var Utils = {
    ...
    isColor: function isColor(val) {
      return /(^#[0-9A-F]{6}$)|(^#[0-9A-F]{3}$)/i.test(val);
    },
    isEmbedObject: function isEmbedObject(val) {
    ...
    isVideoUrl: function isVideoUrl(val) {
      return /youtu\.be|youtube|vimeo/gi.test(val);
    },
    isDate: function isDate(val, format) {
      var result;

      if (_typeof(val) === "object" && Utils.isFunc(val['getMonth'])) {
        return true;
      }
    ...
    isDateObject: function isDateObject(v) {
      return _typeof(v) === 'object' && v['getMonth'] !== undefined;
    },
    ...
    isMetroObject: function isMetroObject(el, type) {
      var $el = $(el),
    ...
    isJQuery: function isJQuery(el) {
      return typeof jQuery !== "undefined" && el instanceof jQuery;
    },
    isM4Q: function isM4Q(el) {
    ...
    embedObject: function embedObject(val) {
      return "<div class='embed-container'>" + $(val)[0].outerHTML + "</div>";
    },
    embedUrl: function embedUrl(val) {
    ...
    hex2rgba: function hex2rgba(hex, alpha) {
      var c;
    ...
    secondsToFormattedString: function secondsToFormattedString(time) {
    ...
    callback: function callback(f, args, context) {
    ...
    isOutsider: function isOutsider(element) {
      var el = $(element);
      var rect;
      var clone = el.clone();
    ...
    getCursorPosition: function getCursorPosition(el, e) {
      var a = Utils.rect(el);
      return {
    ...
    getCursorPositionX: function getCursorPositionX(el, e) {
      return Utils.getCursorPosition(el, e).x;
    },
    getCursorPositionY: function getCursorPositionY(el, e) {
      return Utils.getCursorPosition(el, e).y;
    },
    objectLength: function objectLength(obj) {
      return Object.keys(obj).length;
    },
    percent: function percent(total, part, round_value) {
      if (total === 0) {
        return 0;
      }
    ...
    dashedName: function dashedName(str) {
      return str.replace(/([A-Z])/g, function (u) {
        return "-" + u.toLowerCase();
      });
    },
    objectShift: function objectShift(obj) {
      var min = 0;
      $.each(obj, function (i) {
        if (min === 0) {
          min = i;
    ...
    objectDelete: function objectDelete(obj, key) {
      if (obj[key] !== undefined) delete obj[key];
    },
    arrayDeleteByMultipleKeys: function arrayDeleteByMultipleKeys(arr, keys) {
    ...
    arrayDeleteByKey: function arrayDeleteByKey(arr, key) {
      arr.splice(key, 1);
    },
    nvl: function nvl(data, other) {
    ...
    github: function github(repo, callback) {
    ...
    cleanPreCode: function cleanPreCode(selector) {
    ...
    coords: function coords(element) {
      var el = $(element)[0];
    ...
    positionXY: function positionXY(e, t) {
      switch (t) {
        case 'client':
    ...
    hiddenElementSize: function hiddenElementSize(el, includeMargin) {
      var width,
          height,
          clone = $(el).clone(true);
      clone.removeAttr("data-role").css({
    ...
    getStyle: function getStyle(element, pseudo) {
      var el = $(element)[0];
      return window.getComputedStyle(el, pseudo);
    },
    getStyleOne: function getStyleOne(el, property) {
      return Utils.getStyle(el).getPropertyValue(property);
    },
    getTransformMatrix: function getTransformMatrix(el, returnArray) {
      var computedMatrix = Utils.getStyleOne(el, "transform");
      var a = computedMatrix.replace("matrix(", '').slice(0, -1).split(',');
    ...
    computedRgbToHex: function computedRgbToHex(rgb) {
    ...
    computedRgbToRgba: function computedRgbToRgba(rgb, alpha) {
      var a = rgb.replace(/[^\d,]/g, '').split(',');
    ...
    computedRgbToArray: function computedRgbToArray(rgb) {
      return rgb.replace(/[^\d,]/g, '').split(',');
    },
    hexColorToArray: function hexColorToArray(hex) {
      var c;
    ...
    hexColorToRgbA: function hexColorToRgbA(hex, alpha) {
      var c;
    ...
    updateURIParameter: function updateURIParameter(uri, key, value) {
    ...
    getURIParameter: function getURIParameter(url, name) {
    ...
    strToArray: function strToArray(str, delimiter, type, format) {
      var a;
    ...
    aspectRatioH: function aspectRatioH(width, a) {
      if (a === "16/9") return width * 9 / 16;
      if (a === "21/9") return width * 9 / 21;
      if (a === "4/3") return width * 3 / 4;
    },
    aspectRatioW: function aspectRatioW(height, a) {
      if (a === "16/9") return height * 16 / 9;
      if (a === "21/9") return height * 21 / 9;
      if (a === "4/3") return height * 4 / 3;
    },
    valueInObject: function valueInObject(obj, value) {
      return Object.values(obj).indexOf(value) > -1;
    },
    keyInObject: function keyInObject(obj, key) {
      return Object.keys(obj).indexOf(key) > -1;
    },
    inObject: function inObject(obj, key, val) {
      return obj[key] !== undefined && obj[key] === val;
    },
    newCssSheet: function newCssSheet(media) {
    ...
    media: function media(query) {
      return window.matchMedia(query).matches;
    },
    mediaModes: function mediaModes() {
      return METRO_MEDIA;
    },
    mediaExist: function mediaExist(media) {
      return METRO_MEDIA.indexOf(media) > -1;
    },
    inMedia: function inMedia(media) {
    ...
    isNegative: function isNegative(val) {
      return parseFloat(val) < 0;
    },
    isPositive: function isPositive(val) {
      return parseFloat(val) > 0;
    },
    isZero: function isZero(val) {
      return parseFloat(val.toFixed(2)) === 0.00;
    },
    between: function between(val, bottom, top, equals) {
    ...
    parseCard: function parseCard(val) {
      return val.replace(/[^0-9]/g, '');
    },
    parsePhone: function parsePhone(val) {
    ...
    parseNumber: function parseNumber(val, thousand, decimal) {
      return val.replace(new RegExp('\\' + thousand, "g"), "").replace(new RegExp('\\' + decimal, 'g'), ".");
    },
    nearest: function nearest(val, precision, down) {
      val /= precision;
    ...
    isLocalhost: function isLocalhost(pattern) {
      pattern = pattern || ".local";
      return location.hostname === "localhost" || location.hostname === "127.0.0.1" || location.hostname === "[::1]" || location.hostname === "" || window.location.hostname.match(/^127(?:\.(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)){3}$/) || location.hostname.indexOf(pattern) !== -1;
    },
    formData: function formData(f) {
      var form = $(f)[0];
      var i,
          j,
          q = {};
  ...
  if (_typeof(window["metroAccordionSetup"]) !== undefined) {
  ...
  var Accordion = {
    ...
    _setOptionsFromDOM: function _setOptionsFromDOM() {
    ...
    _createStructure: function _createStructure() {
      var that = this,
    ...
    _createEvents: function _createEvents() {
      var that = this,
          element = this.element,
          o = this.options;
      var active = element.children(".frame.active");
    ...
    _openFrame: function _openFrame(f) {
      var element = this.element,
          o = this.options;
      var frame = $(f);
    ...
    _closeFrame: function _closeFrame(f) {
      var element = this.element,
          o = this.options;
      var frame = $(f);
    ...
    _closeAll: function _closeAll(skip) {
      var that = this,
          element = this.element;
      var frames = element.children(".frame");
    ...
    _hideAll: function _hideAll() {
      ...
      var frames = element.children(".frame");
      $.each(frames, function () {
        $(this).children(".content").hide(); // $(this).children(".content").css("display", "none");
      });
    },
    _openAll: function _openAll() {
      var that = this,
          element = this.element;
      var frames = element.children(".frame");
      $.each(frames, function () {
    ...
    changeAttribute: function changeAttribute(attributeName) {},
  ...
  if (_typeof(window["metroActivitySetup"]) !== undefined) {
  ...
  var Activity = {
    ...
    _create: function _create() {
      ...
      element.html('').addClass(o.style + "-style").addClass("activity-" + o.type);
  ...
  if (_typeof(window["metroAppBarSetup"]) !== undefined) {
  ...
  var AppBar = {
    ...
    destroy: function destroy() {
      ...
      $(window).off(Metro.events.resize, {
        ns: element.attr("id")
      });
      return element;
    }
  ...
  if (_typeof(window["metroAudioSetup"]) !== undefined) {
  ...
  var Audio = {
    ...
    _setSource: function _setSource(src) {
      var element = this.element;
    ...
    _toggleLoop: function _toggleLoop() {
  ...
  if (_typeof(window["metroBottomSheetSetup"]) !== undefined) {
  ...
  var BottomSheet = {
    ...
    _createStructure: function _createStructure() {
      var element = this.element,
          o = this.options;
      element.addClass("bottom-sheet").addClass(o.mode + "-list");
  ...
  Metro['bottomsheet'] = {
    isBottomSheet: function isBottomSheet(el) {
      return Utils.isMetroObject(el, "bottomsheet");
    },
    open: function open(el, as) {
  ...
  if (_typeof(window["metroButtonGroupSetup"]) !== undefined) {
  ...
  var ButtonGroup = {
    ...
    _createGroup: function _createGroup() {
      var element = this.element,
          o = this.options;
      var buttons,
          buttons_active,
  ...
  if (_typeof(window["metroCalendarSetup"]) !== undefined) {
  ...
  var Calendar = {
    ...
    _dates2array: function _dates2array(val, category) {
      var that = this,
          o = this.options;
      var dates;
        ...
        element.on(Metro.events.click, ".week-days .day", function (e) {
          ...
          if (o.multiSelect === true) {
            ...
            $.each(days, function () {
              ...
              if (!that.selected.contains(dd)) that.selected.push(dd);
    ...
    _drawFooter: function _drawFooter() {
      var element = this.element,
          o = this.options;
    ...
    _drawMonths: function _drawMonths() {
      var element = this.element,
          o = this.options;
    ...
    _drawYears: function _drawYears() {
      var element = this.element,
          o = this.options;
    ...
    _drawContent: function _drawContent() {
      var element = this.element,
          o = this.options;
    ...
    _drawCalendar: function _drawCalendar() {
      var that = this;
      setTimeout(function () {
        that.element.html("");
    ...
    getExcluded: function getExcluded() {
      return this.exclude;
    },
    ...
    setExclude: function setExclude(exclude) {
      var element = this.element,
          o = this.options;
    ...
    setSpecial: function setSpecial(special) {
      var element = this.element,
          o = this.options;
    ...
    setToday: function setToday(val) {
      var o = this.options;
    ...
    changeAttrLocale: function changeAttrLocale() {
      var element = this.element,
          o = this.options;
  ...
  if (_typeof(window["metroCalendarPickerSetup"]) !== undefined) {
  ...
  var CalendarPicker = {
    ...
    _createStructure: function _createStructure() {
      ...
      Metro.makePlugin(cal, "calendar", {
        ...
        onDayClick: function onDayClick(sel, day, el) {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeAttrLocale = function changeAttrLocale() {
        that.i18n(element.attr("data-locale"));
      };

      var changeAttrSpecial = function changeAttrSpecial() {
        cal.setSpecial(element.attr("data-special"));
      };

      var changeAttrExclude = function changeAttrExclude() {
        cal.setExclude(element.attr("data-exclude"));
      };

      var changeAttrMinDate = function changeAttrMinDate() {
        cal.setMinDate(element.attr("data-min-date"));
      };

      var changeAttrMaxDate = function changeAttrMaxDate() {
        cal.setMaxDate(element.attr("data-max-date"));
      };

      var changeAttrValue = function changeAttrValue() {
  ...
  if (_typeof(window["metroCarouselSetup"]) !== undefined) {
  ...
  var Carousel = {
    ...
    _createSlides: function _createSlides() {
      var that = this,
          element = this.element,
          o = this.options;
      var slides = element.find(".slide");
    ...
    _createBullets: function _createBullets() {
      var element = this.element,
          o = this.options;
      var bullets, i;
    ...
    _slideToSlide: function _slideToSlide(index) {
      var element = this.element,
          o = this.options;
      var current, next, to;
    ...
    _slideTo: function _slideTo(to, interval) {
      var element = this.element,
          o = this.options;
      var current, next;
    ...
    _effect: function _effect(current, next, effect, to, interval) {
      var that = this,
          element = this.element,
          o = this.options;
      var duration = o.duration;
      var func,
          effectFunc = o.effectFunc;
      var period = o.period;
  ...
  if (_typeof(window["metroCharmsSetup"]) !== undefined) {
  ...
  Metro['charms'] = {
    ...
    opacity: function opacity(el, _opacity) {
      if (this.check(el) === false) return;
      Metro.getPlugin($(el)[0], "charms").opacity(_opacity);
    }
  };
  ...
  if (_typeof(window["metroChatSetup"]) !== undefined) {
  ...
  var Chat = {
    ...
    _createStructure: function _createStructure() {
      ...
      if (!Utils.isNull(o.messages) && _typeof(o.messages) === "object" && Utils.objectLength(o.messages) > 0) {
    ...
    addMessages: function addMessages(messages) {
      ...
      if (_typeof(messages) === "object" && Utils.objectLength(messages) > 0) {
    ...
    updMessage: function updMessage(msg) {
      var element = this.element;
    ...
    toggleReadonly: function toggleReadonly(readonly) {
      var element = this.element,
          o = this.options;
  ...
  if (_typeof(window["metroCheckboxSetup"]) !== undefined) {
  ...
  var Checkbox = {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var indeterminateState = function indeterminateState() {
  ...
  if (_typeof(window["metroClockSetup"]) !== undefined) {
  ...
  var Clock = {
    ...
    _addLeadingZero: function _addLeadingZero(i) {
      if (i < 10) {
        i = "0" + i;
      }
  ...
  if (_typeof(window["metroCollapseSetup"]) !== undefined) {
  ...
  var Collapse = {
    ...
    _close: function _close(el, immediate) {
      var elem = $(el);
    ...
    _open: function _open(el, immediate) {
      var elem = $(el);
      var dropdown = Metro.getPlugin(elem[0], "collapse");
      var options = dropdown.options;
    ...
    collapse: function collapse(immediate) {
      this._close(this.element, immediate);
    },
    expand: function expand(immediate) {
  ...
  if (_typeof(window["metroCountdownSetup"]) !== undefined) {
  ...
  var Countdown = {
    ...
    _setBreakpoint: function _setBreakpoint() {
      var o = this.options;
      var dm = 86400000,
          hm = 3600000,
          mm = 60000,
    ...
    draw: function draw(part, value) {
      ...
      var slideDigit = function slideDigit(digit) {
        var digit_copy,
            height = digit.height();
      ...
      var fadeDigit = function fadeDigit(digit) {
        var digit_copy;
        digit.siblings(".-old-digit").remove();
        digit_copy = digit.clone().appendTo(digit.parent());
        digit_copy.css({
      ...
      var zoomDigit = function zoomDigit(digit) {
        var digit_copy,
            height = digit.height(),
            fs = parseInt(digit.style("font-size"));
        digit.siblings(".-old-digit").remove();
        digit_copy = digit.clone().appendTo(digit.parent());
        digit_copy.css({
          top: 0,
    ...
    getBreakpoint: function getBreakpoint(asDate) {
  ...
  if (_typeof(window["metroCounterSetup"]) !== undefined) {
  ...
  var Counter = {
    ...
    _calcArray: function _calcArray() {
      var o = this.options;
      var i;
      this.numbers = [];
    ...
    setValueAttribute: function setValueAttribute() {
  ...
  if (_typeof(window["metroCubeSetup"]) !== undefined) {
  ...
  var Cube = {
    ...
    _createCssForCellSize: function _createCssForCellSize() {
      var element = this.element,
          o = this.options;
    ...
    _createCssForFlashColor: function _createCssForFlashColor() {
      var element = this.element,
          o = this.options;
      var sheet = Metro.sheet;
      var rule1;
    ...
    _tick: function _tick(index, speed) {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    _toggle: function _toggle(cell, func, time, speed) {
      var that = this;
    ...
    toRule: function toRule(index, speed) {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    _execRule: function _execRule(index, rule, speed) {
      var that = this,
          element = this.element;
      var sides = ['left', 'right', 'top'];
    ...
    axis: function axis(show) {
      var func = show === true ? "show" : "hide";
      this.element.find(".axis")[func]();
    },
    changeRules: function changeRules() {
      var element = this.element,
          o = this.options;
    ...
    destroy: function destroy() {
      ...
      clearInterval(this.interval);
      this.interval = null;
      $(window).off(Metro.events.blur, {
        ns: element.attr("id")
      });
      $(window).off(Metro.events.focus, {
        ns: element.attr("id")
      });
  ...
  if (_typeof(window["metroDatePickerSetup"]) !== undefined) {
  ...
  var DatePicker = {
    ...
    _createStructure: function _createStructure() {
      ...
      if (o.month === true) {
        ...
        for (i = 0; i < o.distance; i++) {
          $("<li>").html("&nbsp;").data("value", -1).appendTo(month);
        }
      ...
      if (o.day === true) {
        ...
        for (i = 0; i < o.distance; i++) {
          $("<li>").html("&nbsp;").data("value", -1).appendTo(day);
        }
      ...
      if (o.year === true) {
        ...
        for (i = 0; i < o.distance; i++) {
          $("<li>").html("&nbsp;").data("value", -1).appendTo(year);
        }
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      function changeFormat() {
        that.options.format = that.element.attr("data-format"); // that.element.val(that.value.format(that.options.format, that.options.locale)).trigger("change");
  ...
  if (_typeof(window["metroDialogSetup"]) !== undefined) {
  ...
  var Dialog = {
    ...
    _build: function _build() {
      ...
      if (o.defaultAction === true || o.actions !== false && _typeof(o.actions) === 'object' && Utils.objectLength(o.actions) > 0) {
  ...
  Metro['dialog'] = {
    ...
    open: function open(el, content, title) {
      if (!this.isDialog(el)) {
        return false;
      }
  ...
  if (_typeof(window["metroDonutSetup"]) !== undefined) {
  ...
  var Donut = {
    ...
    _setValue: function _setValue(v) {
      ...
      var r = o.radius * (1 - (1 - o.hole) / 2);
      var circumference = 2 * Math.PI * r; // var title_value = (o.showValue ? o.value : Math.round(((v * 1000 / o.total) / 10)))+(o.cap);
    ...
    val: function val(v) {
      ...
      this.value = v; //element.attr("data-value", v);
  ...
  if (_typeof(window["metroDragItemsSetup"]) !== undefined) {
  ...
  var DragItems = {
    ...
    _createEvents: function _createEvents() {
      ...
      var move = function move(e, avatar, dragItem) {
        var x = Utils.pageXY(e).x,
            y = Utils.pageXY(e).y;
      ...
      element.on(Metro.events.startAll, o.drawDragMarker ? o.dragMarker : o.dragItem, function (e_start) {
        ...
        doc.on(Metro.events.stopAll, function (e_stop) {
          ...
          avatar.remove();
          doc.off(Metro.events.moveAll, {
            ns: that.id
          });
          doc.off(Metro.events.stopAll, {
            ns: that.id
          });
        }, {
          ns: that.id
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeCanDrag = function changeCanDrag() {
  ...
  if (_typeof(window["metroDraggableSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroDropdownSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroFileSetup"]) !== undefined) {
  ...
  var File = {
    ...
    _createEvents: function _createEvents() {
      ...
      element.on(Metro.events.change, function () {
        var fi = this;
        var file_names = [];
        var entry; // if (fi.files.length === 0) {
        //     return ;
        // }
  ...
  if (_typeof(window["metroGravatarSetup"]) !== undefined) {
  ...
  var Gravatar = {
    ...
    getImage: function getImage(email, size, def, is_jquery_object) {
      var image = $("<img>");
      image.attr("src", this.getImageSrc(email, size));
      return is_jquery_object === true ? image : image[0];
    },
    getImageSrc: function getImageSrc(email, size, def) {
    ...
    resize: function resize(new_size) {
  ...
  if (_typeof(window["metroHintSetup"]) !== undefined) {
  ...
  var Hint = {
    ...
    createHint: function createHint() {
      var elem = this.elem,
          element = this.element,
          o = this.options;
  ...
  var Hotkey = {
    ...
    getKey: function getKey(e) {
      var key,
          k = e.keyCode,
          char = String.fromCharCode(k).toLowerCase();
    ...
    getModifier: function getModifier(e) {
      var m = [];
  ...
  $(document).on(Metro.events.keyup + ".hotkey-data", function (e) {
    ...
    if (METRO_HOTKEYS_FILTER_INPUT_ACCEPTING_ELEMENTS && /textarea|input|select/i.test(e.target.nodeName) || METRO_HOTKEYS_FILTER_CONTENT_EDITABLE && $(e.target).attr('contenteditable') || METRO_HOTKEYS_FILTER_TEXT_INPUTS && Hotkey.textAcceptingInputTypes.indexOf(e.target.type) > -1) {
      return;
    }
  ...
  if (_typeof(window["metroHtmlContainerSetup"]) !== undefined) {
  ...
  var HtmlContainer = {
    ...
    load: function load(source, data, opt) {
      var o = this.options;
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeHTMLSource = function changeHTMLSource() {
      ...
      var changeInsertMode = function changeInsertMode() {
      ...
      var changeRequestData = function changeRequestData() {
  ...
  if (_typeof(window["metroImageCompareSetup"]) !== undefined) {
  ...
  var ImageCompare = {
    ...
    _createEvents: function _createEvents() {
      ...
      slider.on(Metro.events.startAll, function (e) {
        var w = element.width();
        $(document).on(Metro.events.moveAll, function (e) {
          var x = Utils.getCursorPositionX(element[0], e),
              left_pos;
          if (x < 0) x = 0;
          if (x > w) x = w;
          overlay.css({
  ...
  if (_typeof(window["metroImageMagnifierSetup"]) !== undefined) {
  ...
  var ImageMagnifier = {
    ...
    _createEvents: function _createEvents() {
      ...
      var lens_move = function lens_move(pos) {
        var x, y;
        var magic = 4,
            zoom = parseInt(o.magnifierZoom);
  ...
  if (_typeof(window["metroInfoBoxSetup"]) !== undefined) {
  ...
  Metro['infobox'] = {
    isInfoBox: function isInfoBox(el) {
      return Utils.isMetroObject(el, "infobox");
    },
    open: function open(el, c, t) {
      var $$ = Utils.$();
    ...
    setContent: function setContent(el, c) {
      var $$ = Utils.$();
    ...
    create: function create(c, t, o, open) {
      var $$ = Utils.$();
      var el, ib, box_type;
  ...
  if (_typeof(window["metroMaterialInputSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroInputSetup"]) !== undefined) {
  ...
  var Input = {
    ...
    _createStructure: function _createStructure() {
      ...
      if (_typeof(o.customButtons) === "object" && Utils.objectLength(o.customButtons) > 0) {
        $.each(o.customButtons, function () {
          var item = this;
          var customButton = $("<button>");
          customButton.addClass("button input-custom-button").addClass(o.clsCustomButton).addClass(item.cls).attr("tabindex", -1).attr("type", "button").html(item.html);
    ...
    getHistoryIndex: function getHistoryIndex() {
      return this.historyIndex;
    },
    setHistoryIndex: function setHistoryIndex(val) {
      this.historyIndex = val >= this.history.length ? this.history.length - 1 : val;
    },
    setHistory: function setHistory(history, append) {
      var that = this,
          o = this.options;
  ...
  var KeypadDefaultConfig = {
    ...
    shuffle: false,
    shuffleCount: 3,
    position: Metro.position.BOTTOM_LEFT,
  ...
  if (_typeof(window["metroKeypadSetup"]) !== undefined) {
  ...
  var Keypad = {
    ...
    _createKeypad: function _createKeypad() {
      var element = this.element,
          o = this.options;
      var parent = element.parent();
      var keypad, keys;
    ...
    _setKeysPosition: function _setKeysPosition() {
      var element = this.element,
          o = this.options;
    ...
    shuffleKeys: function shuffleKeys(count) {
      if (count === undefined) {
  ...
  if (_typeof(window["metroListSetup"]) !== undefined) {
  ...
  var List = {
    ...
    _createItemsFromHTML: function _createItemsFromHTML() {
      var that = this,
          element = this.element,
          o = this.options;
      this.items = [];
    ...
    _createItemsFromJSON: function _createItemsFromJSON(source) {
      var that = this,
          o = this.options;
      this.items = [];
    ...
    _createTopBlock: function _createTopBlock() {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    _createBottomBlock: function _createBottomBlock() {
      var element = this.element,
          o = this.options;
    ...
    _info: function _info(start, stop, length) {
      var element = this.element,
          o = this.options;
      var component = element.parent();
    ...
    _paging: function _paging(length) {
      var element = this.element,
          o = this.options;
      var component = element.parent();
    ...
    sorting: function sorting(source, dir, redraw) {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    addFilter: function addFilter(f, redraw) {
      var func = Utils.isFunc(f);
    ...
    removeFilter: function removeFilter(key, redraw) {
    ...
    removeFilters: function removeFilters(redraw) {
      this.filters = [];
    ...
    getFiltersIndexes: function getFiltersIndexes() {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeSortDir = function changeSortDir() {
      ...
      var changeSortClass = function changeSortClass() {
      ...
      var changeFilterString = function changeFilterString() {
  ...
  if (_typeof(window["metroListViewSetup"]) !== undefined) {
  ...
  var ListView = {
    ...
    _createIcon: function _createIcon(data) {
      var icon, src;
    ...
    insertBefore: function insertBefore(node, data) {
      var element = this.element,
          o = this.options;
    ...
    insertAfter: function insertAfter(node, data) {
      var element = this.element,
          o = this.options;
      var new_node, parent_node, list;
      node = $(node);
    ...
    selectAll: function selectAll(mode) {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeSelectable = function changeSelectable() {
  ...
  if (_typeof(window["metroMasterSetup"]) !== undefined) {
  ...
  var Master = {
    ...
    _enableControl: function _enableControl(type, state) {
    ...
    _createEvents: function _createEvents() {
      ...
      element.on(Metro.events.click, ".controls .prev", function () {
        ...
        if (Utils.exec(o.onBeforePrev, [that.currentIndex, that.pages[that.currentIndex], element]) === true && Utils.exec(o.onBeforePage, ["prev", that.currentIndex, that.pages[that.currentIndex], element]) === true) {
          that.prev();
        }
      });
      element.on(Metro.events.click, ".controls .next", function () {
        ...
        if (Utils.exec(o.onBeforeNext, [that.currentIndex, that.pages[that.currentIndex], element]) === true && Utils.exec(o.onBeforePage, ["next", that.currentIndex, that.pages[that.currentIndex], element]) === true) {
          that.next();
        }
      });
      $(window).on(Metro.events.resize, function () {
    ...
    _slideToPage: function _slideToPage(index) {
      var current, next, to;
    ...
    _slideTo: function _slideTo(to) {
      var element = this.element,
          o = this.options;
      var current,
          next,
          forward = to.toLowerCase() === 'next';
      current = this.pages[this.currentIndex];
    ...
    _effect: function _effect(current, next, to) {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    changeEffectFunc: function changeEffectFunc() {
      this.options.effectFunc = this.element.attr("data-effect-func");
    },
    changeEffectDuration: function changeEffectDuration() {
  ...
  if (_typeof(window["metroNavigationViewSetup"]) !== undefined) {
  ...
  var NavigationView = {
    ...
    _calcMenuHeight: function _calcMenuHeight() {
      var element = this.element,
          pane,
          menu;
    ...
    _createView: function _createView() {
      ...
      element.addClass("navview").addClass(o.compact !== false ? "navview-compact-" + o.compact : "").addClass(o.expand !== false ? "navview-expand-" + o.expand : "");
      pane = element.children(".navview-pane");
    ...
    pullClick: function pullClick(el) {
      var that = this,
          element = this.element;
      var pane = this.pane;
      ...
      if (that.pane.hasClass("open")) {
        that.close();
      } else if ((pane_compact || element.hasClass("expanded")) && !element.hasClass("compacted")) {
        element.toggleClass("expanded");
      } else if (element.hasClass("compacted") || !pane_compact) {
  ...
  if (_typeof(window["metroNotifySetup"]) !== undefined) {
  ...
  var Notify = {
    ...
    notifies: [],
    setup: function setup(options) {
      this.options = $.extend({}, NotifyDefaultConfig, options); // if (Notify.container === null) {
    ...
    create: function create(message, title, options) {
      var notify,
          that = this,
          o = this.options;
      var m,
          t,
          id = Utils.elementId("notify");
    ...
    kill: function kill(notify, callback) {
      var that = this,
          o = this.options;
  ...
  var createPagination = function createPagination(c) {
    var defConf = {
      length: 0,
      rows: 0,
      current: 0,
    ...
    var add_item = function add_item(item_title, item_type, data) {
      var li, a;
  ...
  if (_typeof(window["metroPanelSetup"]) !== undefined) {
  ...
  var Panel = {
    ...
    _addCustomButtons: function _addCustomButtons(buttons) {
      var element = this.element,
          o = this.options;
      ...
      } else if (_typeof(buttons) === "object" && Utils.objectLength(buttons) > 0) {
      ...
      $.each(customButtons, function () {
        ...
        customButton.addClass("button btn-custom").addClass(o.clsCustomButton).addClass(item.cls).attr("tabindex", -1).html(item.html);
        customButton.data("action", item.onclick);
    ...
    customButtons: function customButtons(buttons) {
  ...
  if (_typeof(window["metroPopoverSetup"]) !== undefined) {
  ...
  var Popover = {
    ...
    destroy: function destroy() {
      ...
      $(window).off(Metro.events.scroll, {
        ns: this.id
      });
      return element;
    }
  ...
  if (_typeof(window["metroProgressSetup"]) !== undefined) {
  ...
  var Progress = {
    ...
    val: function val(v) {
      ...
      var valuePosition = value.width() > diff ? {
        left: "auto",
        right: diff + 'px'
      } : {
        left: v + '%'
    ...
    changeBuffer: function changeBuffer() {
  ...
  if (_typeof(window["metroRadioSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroRatingSetup"]) !== undefined) {
  ...
  var Rating = {
    ...
    _createRating: function _createRating() {
      var element = this.element,
          o = this.options;
    ...
    changeAttributeValue: function changeAttributeValue(a) {
      var element = this.element;
      var value = a === "value" ? element.val() : element.attr("data-value");
      this.val(value);
    },
    changeAttributeMessage: function changeAttributeMessage() {
      var element = this.element;
      var message = element.attr("data-message");
      this.msg(message);
    },
    changeAttributeStatic: function changeAttributeStatic() {
      var element = this.element;
  ...
  if (_typeof(window["metroResizeableSetup"]) !== undefined) {
  ...
  var Resizable = {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var canResize = function canResize() {
  ...
  if (_typeof(window["metroResizerSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroRibbonMenuSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroRippleSetup"]) !== undefined) {
  ...
  var Ripple = {
    ...
    _create: function _create() {
      ...
      element.on(Metro.events.click, target, function (e) {
        ...
        $(".ripple").remove();
        var size = Math.max(el.outerWidth(), el.outerHeight()); // Add the element

        var ripple = $("<span class='ripple'></span>").css({
          width: size,
          height: size
        });
        el.prepend(ripple); // Get the center of the element

        var x = e.pageX - el.offset().left - ripple.width() / 2;
        var y = e.pageY - el.offset().top - ripple.height() / 2; // Add the ripples CSS and start the animation
  ...
  if (_typeof(window["metroSelectSetup"]) !== undefined) {
  ...
  var Select = {
    ...
    _addOption: function _addOption(item, parent) {
      var option = $(item);
      var l, a;
      var element = this.element,
          o = this.options;
    ...
    _addOptionGroup: function _addOptionGroup(item, parent) {
      var that = this;
      var group = $(item);
    ...
    _createOptions: function _createOptions() {
      var that = this,
          element = this.element,
          o = this.options,
    ...
    _createEvents: function _createEvents() {
      ...
      container.on(Metro.events.click, function (e) {
        ...
        container.addClass("focused"); // e.preventDefault();
        // e.stopPropagation();
      });
    ...
    reset: function reset(to_default) {
      var element = this.element,
          o = this.options;
      var options = element.find("option");
  ...
  if (_typeof(window["metroSidebarSetup"]) !== undefined) {
  ...
  var Sidebar = {
    ...
    _checkStatic: function _checkStatic() {
      var element = this.element,
          o = this.options;
  ...
  Metro['sidebar'] = {
    isSidebar: function isSidebar(el) {
  ...
  if (_typeof(window["metroDoubleSliderSetup"]) !== undefined) {
  ...
  var DoubleSlider = {
    ...
    _convert: function _convert(v, how) {
    ...
    _correct: function _correct(value) {
      var res = value;
      var accuracy = this.options.accuracy;
      var min = this.options.min,
          max = this.options.max;

      var _dec = function _dec(v) {
        return v % 1 === 0 ? 0 : v.toString().split(".")[1].length;
      };
  ...
  if (_typeof(window["metroSliderSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroSorterSetup"]) !== undefined) {
  ...
  var Sorter = {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeSortContent = function changeSortContent() {
  ...
  Metro['sorter'] = {
    create: function create(el, op) {
      return Utils.$()(el).sorter(op);
    },
    isSorter: function isSorter(el) {
      return Utils.isMetroObject(el, "sorter");
    },
    sort: function sort(el, dir) {
      if (!this.isSorter(el)) {
        return false;
      }
  ...
  if (_typeof(window["metroSpinnerSetup"]) !== undefined) {
  ...
  var Spinner = {
    ...
    _createEvents: function _createEvents() {
      ...
      var spinnerButtonClick = function spinnerButtonClick(plus, threshold) {
        var curr = element.val();
    ...
    _setValue: function _setValue(val, trigger_change) {
      var element = this.element,
          o = this.options;
    ...
    val: function val(_val2) {
      ...
      if (!Utils.isValue(_val2)) {
        return element.val();
      }

      that._setValue(_val2.toFixed(o.fixed), true);
    },
    toDefault: function toDefault() {
      var element = this.element,
          o = this.options;
  ...
  if (_typeof(window["metroSplitterSetup"]) !== undefined) {
  ...
  var Splitter = {
    ...
    _createEvents: function _createEvents() {
      ...
      gutters.on(Metro.events.startAll, function (e) {
        ...
        $(window).on(Metro.events.stopAll, function (e) {
          ...
          $(window).off(Metro.events.moveAll, {
            ns: id
          });
          $(window).off(Metro.events.stopAll, {
            ns: id
          });
    ...
    size: function size(_size2) {
      var that = this,
          o = this.options;

      if (Utils.isValue(_size2)) {
        o.splitSizes = _size2;
  ...
  if (_typeof(window["metroStepperSetup"]) !== undefined) {
  ...
  var Stepper = {
    ...
    _createStepper: function _createStepper() {
      var element = this.element,
          o = this.options;
      var i;
  ...
  Storage.prototype = {
    ...
    getItem: function getItem(key, default_value, reviver) {
      var result, value;
    ...
    getItemPart: function getItemPart(key, sub_key, default_value, reviver) {
      var i;
  ...
  if (_typeof(window["metroStreamerSetup"]) !== undefined) {
  ...
  var Streamer = {
    ...
    build: function build() {
      ...
      if (data.streams !== undefined) {
        $.each(data.streams, function (stream_index) {
          ...
          var stream_events = $("<div>").addClass("stream-events").data("background-color", bg).data("text-color", fg).appendTo(event_group_main);
          ...
          if (stream_item.events !== undefined) {
            $.each(stream_item.events, function (event_index) {
              ...
              event = $("<div>").data("origin", event_item).data("sid", sid).data("data", event_item.data).data("time", event_item.time).data("target", event_item.target).addClass("stream-event").addClass("size-" + event_item.size + "x").addClass(event_item.cls).appendTo(stream_events);
        ...
        $.each(['before', 'after'], function () {
          ...
          if (data.global[global_item] !== undefined) {
            $.each(data.global[global_item], function () {
              ...
              var left,
                  t = timeline.find(".js-time-point-" + this.time.replace(":", "-"));
    ...
    _fireScroll: function _fireScroll() {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    _createEvents: function _createEvents() {
      ...
      element.off(Metro.events.click, ".stream-event").on(Metro.events.click, ".stream-event", function (e) {
        ...
        if (o.closed === false && event.data("closed") !== true && o.eventClick === 'select') {
          if (o.excludeSelectClass !== "" && event.hasClass(o.excludeSelectClass)) {} else {
            if (o.excludeSelectElement !== null && $(e.target).is(o.excludeSelectElement)) {} else {
          ...
          if (o.excludeClickClass !== "" && event.hasClass(o.excludeClickClass)) {} else {
            if (o.excludeClickElement !== null && $(e.target).is(o.excludeClickElement)) {} else {
    ...
    _changeURI: function _changeURI() {
      var that = this,
          element = this.element,
          o = this.options,
          data = this.data;
    ...
    enableStream: function enableStream(stream) {
      var that = this,
          element = this.element,
          o = this.options,
          data = this.data;
    ...
    disableStream: function disableStream(stream) {
      var that = this,
          element = this.element,
          o = this.options,
          data = this.data;
    ...
    toggleStream: function toggleStream(stream) {
    ...
    getEvents: function getEvents(event_type, include_global) {
      var that = this,
          element = this.element,
          o = this.options,
          data = this.data;
    ...
    getStreamerData: function getStreamerData() {
      return this.data;
    },
    ...
    selectEvent: function selectEvent(event, state) {
      var that = this,
          element = this.element,
          o = this.options,
          data = this.data;
    ...
    changeData: function changeData(data) {
      ...
      o.data = _typeof(data) === 'object' ? data : JSON.parse(element.attr("data-data"));
      this.data = o.data;
      this.build();
    ...
    changeStreamSelectOption: function changeStreamSelectOption() {
      var that = this,
          element = this.element,
          o = this.options,
          data = this.data;
    ...
    destroy: function destroy() {
      ...
      element.find(".events-area").off(Metro.events.mousewheel);
      element.find(".events-area").last().off("scroll"); // element.off(Metro.events.click, ".stream");
  ...
  if (_typeof(window["metroSwitchSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroTableSetup"]) !== undefined) {
  ...
  var Table = {
    ...
    _create: function _create() {
      ...
      if (o.source !== null) {
        ...
        } else this.activity.show(function () {
          $.json(o.source).then(function (data) {
            that.activity.hide();
    ...
    _createIndex: function _createIndex() {
      var that = this,
    ...
    _build: function _build(data) {
      ...
      if (o.viewSaveMode.toLowerCase() === "client") {
        ...
        $.json(viewPath, viewPath !== o.viewSavePath ? null : {
          id: id
        }).then(function (view) {
    ...
    _createInspectorItems: function _createInspectorItems(table) {
      var that = this,
          o = this.options;
      var j,
          tds = [],
      ...
      $.each(cells, function (i) {
        ...
        $("<td>").html("" + "<button class='button square js-table-inspector-field-up' type='button'><span class='mif-arrow-up'></span></button>" + "<button class='button square js-table-inspector-field-down' type='button'><span class='mif-arrow-down'></span></button>" + "").appendTo(row);
    ...
    _createInspector: function _createInspector() {
      var o = this.options;
    ...
    _resetInspector: function _resetInspector() {
    ...
    _createHeadsFromHTML: function _createHeadsFromHTML() {
      var that = this,
          element = this.element;
    ...
    _createFootsFromHTML: function _createFootsFromHTML() {
      var that = this,
          element = this.element;
    ...
    _createTableHeader: function _createTableHeader() {
      var element = this.element,
          o = this.options;
      var head = $("<thead>").html('');
      var tr,
    ...
    _createTableFooter: function _createTableFooter() {
      var element = this.element,
          o = this.options;
    ...
    _resetSortClass: function _resetSortClass(el) {
    ...
    _createInspectorEvents: function _createInspectorEvents() {
      var that = this,
          inspector = this.inspector; // Inspector event
    ...
    _removeInspectorEvents: function _removeInspectorEvents() {
      var inspector = this.inspector;
    ...
    _saveTableView: function _saveTableView() {
      var element = this.element,
          o = this.options;
      var view = this.view;
      var id = element.attr("id");
      ...
      if (o.viewSaveMode.toLowerCase() === "client") {
        ...
        $.post(viewPath, post_data).then(function (data) {
        ...
        items = this.items.filter(function (row) {
          ...
          if (that.filters.length > 0) {
            ...
            for (i = 0; i < that.filters.length; i++) {
              ...
              j++;
              result = o.filtersOperator.toLowerCase() === "and" ? result && Utils.exec(that.filters[i], [row, that.heads]) : result || Utils.exec(that.filters[i], [row, that.heads]);
            }
    ...
    _getItemContent: function _getItemContent(row) {
      var o = this.options;
      var result,
    ...
    addItem: function addItem(item, redraw) {
    ...
    addItems: function addItems(items, redraw) {
    ...
    updateItem: function updateItem(key, field, value) {
    ...
    deleteItem: function deleteItem(fieldIndex, value) {
      var i,
          deleteIndexes = [];
      var is_func = Utils.isFunc(value);
    ...
    deleteItemByName: function deleteItemByName(fieldName, value) {
      var i,
          fieldIndex,
          deleteIndexes = [];
      var is_func = Utils.isFunc(value);
    ...
    _rebuild: function _rebuild(review) {
      var that = this,
          element = this.element;
      var need_sort = false,
          sortable_columns;
    ...
    setHeads: function setHeads(data) {
      this.heads = data;
      return this;
    },
    setHeadItem: function setHeadItem(name, data) {
      var i, index;
    ...
    loadData: function loadData(source, review) {
      var that = this,
          element = this.element,
          o = this.options;
    ...
    getStoredKeys: function getStoredKeys() {
      var element = this.element,
          o = this.options;
      return Metro.storage.getItem(o.checkStoreKey.replace("$1", element.attr("id")), []);
    },
    clearSelected: function clearSelected(redraw) {
      var element = this.element,
          o = this.options;
    ...
    openInspector: function openInspector(mode) {
    ...
    export: function _export(to, mode, filename, options) {
      ...
      filename = Utils.isValue(filename) ? filename : Utils.elementId("table") + "-export.csv"; // Create table header
      ...
      tr.appendTo(head); // Create table data
  ...
  if (_typeof(window["metroMaterialTabsSetup"]) !== undefined) {
  ...
  var MaterialTabs = {
    ...
    _applyColor: function _applyColor(to, color, option) {
      to = $(to);
    ...
    openTab: function openTab(tab, tab_next) {
      var element = this.element,
          o = this.options;
      var tabs = element.find("li");
      var magic = 52,
  ...
  if (_typeof(window["metroTabsSetup"]) !== undefined) {
  ...
  var Tabs = {
    ...
    _collectTargets: function _collectTargets() {
      var that = this,
          element = this.element;
      var tabs = element.find("li");
      this._targets = [];
  ...
  if (_typeof(window["metroTagInputSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroTextareaSetup"]) !== undefined) {
  ...
  if (_typeof(window["metroTileSetup"]) !== undefined) {
  ...
  var Tile = {
    ...
    _runEffects: function _runEffects() {
      var that = this,
          o = this.options;
    ...
    _stopEffects: function _stopEffects() {
      $.clearInterval(this.effectInterval);
      this.effectInterval = false;
    },
    _setCover: function _setCover(to, src, pos) {
  ...
  if (_typeof(window["metroTimePickerSetup"]) !== undefined) {
  ...
  var TimePicker = {
    ...
    _normalizeValue: function _normalizeValue() {
      var o = this.options;
    ...
    _createStructure: function _createStructure() {
      ...
      if (o.hours === true) {
        ...
        for (i = 0; i < o.distance; i++) {
          $("<li>").html("&nbsp;").data("value", -1).appendTo(hours);
        }
      ...
      if (o.minutes === true) {
        ...
        for (i = 0; i < o.distance; i++) {
          $("<li>").html("&nbsp;").data("value", -1).appendTo(minutes);
        }
      ...
      if (o.seconds === true) {
        ...
        for (i = 0; i < o.distance; i++) {
          $("<li>").html("&nbsp;").data("value", -1).appendTo(seconds);
        }
    ...
    open: function open() {
      ...
      var animateList = function animateList(list, item) {
    ...
    changeAttribute: function changeAttribute(attributeName) {
      ...
      var changeValueAttribute = function changeValueAttribute() {
  ...
  var Toast = {
    ...
    create: function create(message, callback, timeout, cls, options) {
  ...
  var Touch = {
    init: function init(options, elem) {
      ...
      this.CANCEL_EV = TouchConst.SUPPORTS_POINTER ? TouchConst.SUPPORTS_POINTER_IE10 ? 'MSPointerCancel' : 'pointercancel' : 'touchcancel'; //touch properties
      ...
      this.maximumsMap = null; //Current phase of th touch cycle

      this.phase = "start"; // the current number of fingers being used.

      this.fingerCount = 0; //track mouse points / delta

      this.fingerData = {}; //track times

      this.startTime = 0;
      this.endTime = 0;
      this.previousTouchEndTime = 0;
      this.fingerCountAtRelease = 0;
      this.doubleTapStartTime = 0; //Timeouts
    ...
    options: {
      ...
      onSwipeStatus: Metro.noop_true,
      // params: phase, direction, distance, duration, fingerCount, fingerData, currentDirection
    ...
    touchStart: function touchStart(e) {
      var element = this.element,
          options = this.options; //If we already in a touch event (a finger already in use) then ignore subsequent ones..
      ...
      this.phase = TouchConst.PHASE_START; //If we support touches, get the finger count
      ...
      this.cancelMultiFingerRelease(); //Create the default finger data

      this.createFingerData(0, evt); // check the number of fingers is what we are looking for, or we are capturing pinches
    ...
    touchMove: function touchMove(e) {
      //As we use Jquery bind for events, we need to target the original event object
      //If these events are being programmatically triggered, we don't have an original event object, so use the Jq one.
      var event = e; //If we are ending, cancelling, or within the threshold of 2 fingers being released, don't track anything..

      if (this.phase === TouchConst.PHASE_END || this.phase === TouchConst.PHASE_CANCEL || this.inMultiFingerRelease()) return;
      var ret,
          touches = event.touches,
      ...
      this.phase = TouchConst.PHASE_MOVE; //If we have 2 fingers get Touches distance as well
      ...
      if (this.fingerCount === this.options.fingers || this.options.fingers === TouchConst.ALL_FINGERS || !touches || this.hasPinches()) {
        ...
        this.direction = this.calculateDirection(currentFinger.start, currentFinger.end); //The immediate direction of the swipe, direction between the last movement and this one.

        this.currentDirection = this.calculateDirection(currentFinger.last, currentFinger.end); //Check if we need to prevent default event (page scroll / pinch zoom) or not

        this.validateDefaultEvent(e, this.currentDirection); //Distance and duration are all off the main finger

        this.distance = this.calculateDistance(currentFinger.start, currentFinger.end);
        this.duration = this.calculateDuration(); //Cache the maximum distance we made in this direction

        this.setMaxDistance(this.direction, this.distance); //Trigger status handler

        ret = this.triggerHandler(event, this.phase); //If we trigger end events when threshold are met, or trigger events when touch leaves element
    ...
    touchEnd: function touchEnd(e) {
      ...
      this.endTime = this.getTimeStamp(); //Get duration incase move was never fired

      this.duration = this.calculateDuration(); //If we trigger handlers at end of swipe OR, we trigger during, but they didnt trigger and we are still in the move phase
    ...
    touchCancel: function touchCancel() {
      ...
      this.startTouchesDistance = 0;
      this.endTouchesDistance = 0;
      this.pinchZoom = 1; //If we were in progress of tracking a possible multi touch end, then re set it.
    ...
    getNextPhase: function getNextPhase(currentPhase) {
      var options = this.options;
      ...
      var didCancel = this.didSwipeBackToCancel(); //If we have exceeded our time, then cancel
    ...
    triggerHandler: function triggerHandler(event, phase) {
      var ret,
    ...
    triggerHandlerForGesture: function triggerHandlerForGesture(event, phase, gesture) {
      var ret,
          element = this.element,
          options = this.options; //SWIPES....
      ...
      if (gesture === TouchConst.TAP) {
        if (phase === TouchConst.PHASE_CANCEL || phase === TouchConst.PHASE_END) {
          clearTimeout(this.singleTapTimeout);
          clearTimeout(this.holdTimeout); //If we are also looking for doubelTaps, wait incase this is one...

          if (this.hasDoubleTap() && !this.inDoubleTap()) {
            this.doubleTapStartTime = this.getTimeStamp(); //Now wait for the double tap timeout, and trigger this single tap
    ...
    validateSwipeDistance: function validateSwipeDistance() {
    ...
    didSwipeBackToCancel: function didSwipeBackToCancel() {
      var options = this.options;
      var cancelled = false;
    ...
    validatePinchDistance: function validatePinchDistance() {
    ...
    validateSwipeTime: function validateSwipeTime() {
      var result,
    ...
    validateDefaultEvent: function validateDefaultEvent(e, direction) {
      var options = this.options; //If the option is set, allways allow the event to bubble up (let user handle weirdness)
    ...
    validatePinch: function validatePinch() {
    ...
    hasPinches: function hasPinches() {
      //Enure we dont return 0 or null for false values
      return !!(this.options.onPinchStatus || this.options.onPinchIn || this.options.onPinchOut);
    },
    didPinch: function didPinch() {
      //Enure we dont return 0 or null for false values
      return !!(this.validatePinch() && this.hasPinches());
    },
    validateSwipe: function validateSwipe() {
      //Check validity of swipe
      var hasValidTime = this.validateSwipeTime();
      var hasValidDistance = this.validateSwipeDistance();
      var hasCorrectFingerCount = this.validateFingers();
      var hasEndPoint = this.validateEndPoint();
      var didCancel = this.didSwipeBackToCancel(); // if the user swiped more than the minimum length, perform the appropriate action
      // hasValidDistance is null when no distance is set

      return !didCancel && hasEndPoint && hasCorrectFingerCount && hasValidDistance && hasValidTime;
    },
    hasSwipes: function hasSwipes() {
      var o = this.options; //Enure we dont return 0 or null for false values

      return !!(o.onSwipe !== Metro.noop || o.onSwipeStatus !== Metro.noop || o.onSwipeLeft !== Metro.noop || o.onSwipeRight !== Metro.noop || o.onSwipeUp !== Metro.noop || o.onSwipeDown !== Metro.noop);
    },
    didSwipe: function didSwipe() {
      //Enure we dont return 0 or null for false values
      return !!(this.validateSwipe() && this.hasSwipes());
    },
    validateFingers: function validateFingers() {
    ...
    validateEndPoint: function validateEndPoint() {
      //We have an end value for the finger
      return this.fingerData[0].end.x !== 0;
    },
    hasTap: function hasTap() {
      //Enure we dont return 0 or null for false values
      return this.options.onTap !== Metro.noop;
    },
    hasDoubleTap: function hasDoubleTap() {
      //Enure we dont return 0 or null for false values
      return this.options.onDoubleTap !== Metro.noop;
    },
    hasLongTap: function hasLongTap() {
      //Enure we dont return 0 or null for false values
      return this.options.onLongTap !== Metro.noop;
    },
    validateDoubleTap: function validateDoubleTap() {
    ...
    inDoubleTap: function inDoubleTap() {
      return this.validateDoubleTap();
    },
    validateTap: function validateTap() {
      return (this.fingerCount === 1 || !TouchConst.SUPPORTS_TOUCH) && (isNaN(this.distance) || this.distance < this.options.threshold);
    },
    validateLongTap: function validateLongTap() {
      var options = this.options; //slight threshold on moving finger
    ...
    didTap: function didTap() {
      //Enure we dont return 0 or null for false values
      return !!(this.validateTap() && this.hasTap());
    },
    didDoubleTap: function didDoubleTap() {
      //Enure we dont return 0 or null for false values
      return !!(this.validateDoubleTap() && this.hasDoubleTap());
    },
    didLongTap: function didLongTap() {
      //Enure we dont return 0 or null for false values
      return !!(this.validateLongTap() && this.hasLongTap());
    },
    startMultiFingerRelease: function startMultiFingerRelease(event) {
      this.previousTouchEndTime = this.getTimeStamp();
      this.fingerCountAtRelease = event.touches.length + 1;
    },
    cancelMultiFingerRelease: function cancelMultiFingerRelease() {
      this.previousTouchEndTime = 0;
      this.fingerCountAtRelease = 0;
    },
    inMultiFingerRelease: function inMultiFingerRelease() {
    ...
    getTouchInProgress: function getTouchInProgress() {
      var element = this.element; //strict equality to ensure only true and false are returned

      return element.data('intouch') === true;
    },
    setTouchInProgress: function setTouchInProgress(val) {
      var element = this.element; //If destroy is called in an event handler, we have no el, and we have already cleaned up, so return.
      ...
      if (val === true) {
        ...
        element.on(this.END_EV, $.proxy(this.touchEnd, this)); //we only have leave events on desktop, we manually calcuate leave on touch as its not supported in webkit
        ...
        element.off(this.END_EV); //we only have leave events on desktop, we manually calcuate leave on touch as its not supported in webkit
    ...
    createFingerData: function createFingerData(id, evt) {
      var f = {
        start: {
          x: 0,
          y: 0
    ...
    updateFingerData: function updateFingerData(evt) {
    ...
    getFingerData: function getFingerData(id) {
      return this.fingerData[id] || null;
    },
    setMaxDistance: function setMaxDistance(direction, distance) {
    ...
    getMaxDistance: function getMaxDistance(direction) {
      return this.maximumsMap[direction] ? this.maximumsMap[direction].distance : undefined;
    },
    createMaximumsData: function createMaximumsData() {
      var maxData = {};
    ...
    createMaximumVO: function createMaximumVO(dir) {
      return {
        direction: dir,
        distance: 0
      };
    ...
    calculateTouchesDistance: function calculateTouchesDistance(startPoint, endPoint) {
      var diffX = Math.abs(startPoint.x - endPoint.x);
      var diffY = Math.abs(startPoint.y - endPoint.y);
      return Math.round(Math.sqrt(diffX * diffX + diffY * diffY));
    },
    calculatePinchZoom: function calculatePinchZoom(startDistance, endDistance) {
      var percent = endDistance / startDistance * 100; // 1 ? 100

      return percent.toFixed(2);
    },
    calculatePinchDirection: function calculatePinchDirection() {
      if (this.pinchZoom < 1) {
    ...
    calculateDistance: function calculateDistance(startPoint, endPoint) {
      return Math.round(Math.sqrt(Math.pow(endPoint.x - startPoint.x, 2) + Math.pow(endPoint.y - startPoint.y, 2)));
    },
    calculateAngle: function calculateAngle(startPoint, endPoint) {
    ...
    calculateDirection: function calculateDirection(startPoint, endPoint) {
    ...
    isInBounds: function isInBounds(point, bounds) {
      return point.x > bounds.left && point.x < bounds.right && point.y > bounds.top && point.y < bounds.bottom;
    },
    comparePoints: function comparePoints(pointA, pointB) {
    ...
    removeListeners: function removeListeners() {
      ...
      element.off(this.MOVE_EV);
      element.off(this.END_EV); //we only have leave events on desktop, we manually calculate leave on touch as its not supported in webkit
  ...
  if (_typeof(window["metroTreeViewSetup"]) !== undefined) {
  ...
  var TreeView = {
    ...
    toggleNode: function toggleNode(n) {
      var node = $(n);
      var element = this.element,
          o = this.options;
      var func;
    ...
    addTo: function addTo(node, data) {
      var element = this.element,
          o = this.options;
      var target;
      var new_node;
  ...
  var ValidatorFuncs = {
    ...
    length: function length(val, len) {
      if (Array.isArray(val)) {
    ...
    date: function date(val, format, locale) {
    ...
    compare: function compare(val, val2) {
      return val === val2;
    },
    not: function not(val, not_this) {
      return val !== not_this;
    },
    notequals: function notequals(val, val2) {
      if (Utils.isNull(val)) return false;
      if (Utils.isNull(val2)) return false;
      return val.trim() !== val2.trim();
    },
    equals: function equals(val, val2) {
      if (Utils.isNull(val)) return false;
      if (Utils.isNull(val2)) return false;
      return val.trim() === val2.trim();
    },
    custom: function custom(val, func) {
    ...
    is_control: function is_control(el) {
      return el.parent().hasClass("input") || el.parent().hasClass("select") || el.parent().hasClass("textarea") || el.parent().hasClass("checkbox") || el.parent().hasClass("switch") || el.parent().hasClass("radio") || el.parent().hasClass("spinner");
    },
    reset_state: function reset_state(el) {
      var input = $(el);
    ...
    set_valid_state: function set_valid_state(el) {
      var input = $(el);
      var is_control = ValidatorFuncs.is_control(input);
    ...
    set_invalid_state: function set_invalid_state(el) {
      var input = $(el);
      var is_control = ValidatorFuncs.is_control(input);
    ...
    validate: function validate(el, result, cb_ok, cb_error, required_mode) {
  ...
  if (_typeof(window["metroValidatorSetup"]) !== undefined) {
  ...
  var Validator = {
    ...
    _create: function _create() {
      ...
      element.attr("novalidate", 'novalidate'); //.attr("action", "javascript:");
  ...
  if (_typeof(window["metroVideoSetup"]) !== undefined) {
  ...
  var Video = {
    ...
    _setAspectRatio: function _setAspectRatio() {
      var player = this.player,
          o = this.options;
    ...
    aspectRatio: function aspectRatio(ratio) {
    ...
    changeAspectRatio: function changeAspectRatio() {
  ...
  if (_typeof(window["metroWindowSetup"]) !== undefined) {
  ...
  var Window = {
    ...
    _create: function _create() {
      ...
      if (Utils.isNull(o.content)) {
        ...
        } else if (!Utils.isQ(o.content) && Utils.isFunc(o.content)) {
    ...
    _window: function _window(o) {
      ...
      if (Utils.isValue(o.customButtons)) {
        ...
        } else if (_typeof(o.customButtons) === "object" && Utils.objectLength(o.customButtons) > 0) {
    ...
    maximized: function maximized(e) {
      var win = this.win,
          element = this.element,
          o = this.options;
    ...
    changeSize: function changeSize(a) {
      var element = this.element,
          win = this.win;
    ...
    changeClass: function changeClass(a) {
      var element = this.element,
          win = this.win,
          o = this.options;
    ...
    toggleResizable: function toggleResizable() {
      var element = this.element,
          win = this.win;
    ...
    changeTopLeft: function changeTopLeft(a) {
      var element = this.element,
          win = this.win;
      var pos;
    ...
    changePlace: function changePlace(p) {
      var element = this.element,
          win = this.win;
  ...
  Metro['window'] = {
    isWindow: function isWindow(el) {
      return Utils.isMetroObject(el, "window");
    },
    min: function min(el, a) {
      if (!this.isWindow(el)) {
        return false;
      }
  ...
  if (_typeof(window["metroWizardSetup"]) !== undefined) {
  ...
  var Wizard = {
    ...
    _createWizard: function _createWizard() {
      var that = this,
          element = this.element,
          o = this.options;
      var bar;
    ...
    toPage: function toPage(page) {
      ...
      this.current = page;
      element.children("section").removeClass("complete current").removeClass(o.clsCurrent).removeClass(o.clsComplete);
      target.addClass("current").addClass(o.clsCurrent);
      target.prevAll().addClass("complete").addClass(o.clsComplete);
  ...
  if (METRO_INIT === true) {
    METRO_INIT_MODE === 'immediate' ? Metro.init() : $(function () {
      Metro.init();
    });
  }
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/lib/metro.js"], null)
//# sourceMappingURL=/metro.8ddfe449.js.map